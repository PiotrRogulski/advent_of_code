            ...
            children: [
              Card(
                child: AocSwitchListTile(
                  ...
                  onChanged: (value) {
                    settingsStore.themeMode.value = value ? .dark : .light;
                  },
                  value: useValueStream(settingsStore.themeMode) == .dark,
                ),
              ),
              Card(
                child: AocSwitchListTile(
                  ...
                  onChanged: (value) {
                    settingsStore.useSystemTheme.value = value;
                  },
                  value: useValueStream(settingsStore.useSystemTheme),
                ),
              ),
              Card(
                child: AocSwitchListTile(
                  ...
                  onChanged: (value) {
                    settingsStore.christmasSpirit.value = value;
                  },
                  value: useValueStream(settingsStore.christmasSpirit),
                ),
              ),
              AocDropdownListTile(
                ...
                currentValue: useValueStream(settingsStore.locale),
